...
CREATE TABLE IF NOT EXISTS pur_weigh_ticket (
  ...
  plate_no VARCHAR(32) NULL COMMENT '车牌',
  receive_address VARCHAR(256) NULL COMMENT '收货地址',
  pass_rate DECIMAL(8,4) NOT NULL DEFAULT 0 COMMENT '规格抽检合格率%',
  reject_weight DECIMAL(18,4) NOT NULL DEFAULT 0 COMMENT '不合格重量',
...
CREATE TABLE IF NOT EXISTS pur_farmer_settlement (
  ...
  goods_amount DECIMAL(18,4) NOT NULL DEFAULT 0 COMMENT '货款=净重×单价',
  freight_fee DECIMAL(18,4) NOT NULL DEFAULT 0,
  loading_fee DECIMAL(18,4) NOT NULL DEFAULT 0,
  weigh_fee DECIMAL(18,4) NOT NULL DEFAULT 0,
  amount DECIMAL(18,4) NOT NULL DEFAULT 0 COMMENT '结算=货款+三项费用',
