...
var resourceDomainModule = map[string]domainModule{
	...
	"purchase/weigh-tickets": {"采购管理", "过磅收货"}, "purchase/farmer-settlements": {"采购管理", "农户结算"},
...
var allDomainMenus = []struct {
	...
	{"采购管理", []string{"供应商管理", "农户档案", "过磅收货", "农户结算", "原料溯源", "采购申请", "采购计划单", "采购入库", "来料质检", "采购退货", "采购分析", "历史价格查看", "采购任务管理"}},
