  ...
  switch (role) {
    case WorkbenchRole.receiving:
      return const [
        ...
        RoleStep(title: '出码推仓', subtitle: '生成板码并推送待入库', route: '/receiving'),
      ];
    case WorkbenchRole.warehouse:
      return const [
        ...
        RoleStep(title: '库存与板码', subtitle: '查库存、板码管理', route: '/warehouse'),
        RoleStep(title: '盘点', subtitle: '仓库/车间盘点', route: '/warehouse'),
      ];
    case WorkbenchRole.workshop:
      return const [
        RoleStep(title: '工序过站', subtitle: '扫工牌+板码按 kg 领料', route: '/station'),
        RoleStep(title: '班组异常', subtitle: '返工派岗、废料处理', route: '/workshop'),
      ];
    case WorkbenchRole.worker:
      return const [
        RoleStep(title: '工序过站', subtitle: '扫工牌+板码，领取/退库/进下道', route: '/station'),
