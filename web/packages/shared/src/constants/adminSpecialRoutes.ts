...
export const ADMIN_SPECIAL_MODULE_PATHS: Record<string, string> = {
  ...
  '人事管理/人事调动': '/hr/personnel-transfers',
  ...
  '种植管理/木薯种植管理': '/planting/hub/overview',
  '种植管理/地块档案': '/planting/hub/plots',
  '种植管理/种植合同': '/planting/hub/contracts',
  '种植管理/田间作业': '/planting/hub/field-logs',
  '种植管理/采收计划': '/planting/hub/harvest-plans',
