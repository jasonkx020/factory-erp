...
func RegisterProductionExtra(r *gin.RouterGroup, h Handler) {
	...
	r.GET("/production/material-dispatches", h.Dispatch("GET", "/api/v1/production/material-dispatches", "/production/material-dispatches", "production/material-dispatches", "list"))
	r.GET("/production/material-dispatches/wage-summary", h.Dispatch("GET", "/api/v1/production/material-dispatches/wage-summary", "/production/material-dispatches/wage-summary", "production/material-dispatches", "list"))
	r.POST("/production/material-dispatches", h.Dispatch("POST", "/api/v1/production/material-dispatches", "/production/material-dispatches", "production/material-dispatches", "create"))
	r.POST("/production/material-dispatches/:id/complete", h.Dispatch("POST", "/api/v1/production/material-dispatches/{id}/complete", "/production/material-dispatches/:id/complete", "production/material-dispatches", "action:complete"))
