  ...
  routes: [
    { path: '/login', name: 'login', component: () => import('./views/LoginView.vue'), meta: { public: true } },
    {
      ...
      children: [
        ...
        { path: 'asset/:pathMatch(.*)*', redirect: '/' },
        { path: 'approval/:pathMatch(.*)*', redirect: '/' },
        { path: 'product/products', redirect: '/product/hub/products' },
        { path: 'finance/vouchers', redirect: '/finance/hub/vouchers' },
        { path: 'report/dashboards/boss', redirect: '/report/hub/production-board' },
        ...
        { path: 'hr/plants', name: 'hr-plants', component: () => import('./views/hr/PlantsView.vue') },
        { path: 'system/setup', name: 'system-setup', component: () => import('./views/system/SetupView.vue') },
        ...
        { path: 'purchase/hub/farmers', redirect: '/purchase/hub/suppliers' },
