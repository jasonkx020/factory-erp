...
INSERT INTO iam_permission(code, name, domain, module, action) VALUES
 ...
 ('财务管理:资金管理:查看', '资金管理', '财务管理', '资金管理', '查看'),
 ('财务管理:资金管理:编辑', '资金管理编辑', '财务管理', '资金管理', '编辑'),
 ('财务管理:交易流水账:查看', '交易流水账', '财务管理', '交易流水账', '查看'),
 ('财务管理:交易流水账:编辑', '交易流水账编辑', '财务管理', '交易流水账', '编辑'),
 ('财务管理:农户应付:查看', '农户应付', '财务管理', '农户应付', '查看'),
 ('财务管理:农户应付:编辑', '农户应付编辑', '财务管理', '农户应付', '编辑')
ON CONFLICT DO NOTHING;
