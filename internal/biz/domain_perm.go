...
var allDomainMenus = []struct {
	...
	{"生产管理", []string{"多单整合管理", "生产任务单", "图纸分发", "工序定义", "工艺流程", "产线班次", "例外派岗", "灵活派发工单", "过站记录", "计件工资", "计件领料表", "自动BOM", "MRP物料分析", "联动式领料", "车间工作台", "工序在制", "车间管理", "委外加工", "受托加工生产流程管控", "成本隐藏", "一单多商品", "进度跟踪", "质检管理", "返修单", "废料管理"}},
