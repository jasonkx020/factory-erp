...
INSERT OR IGNORE INTO sys_organization(id, code, name, status) VALUES (1, 'ORG001', '加工厂演示组织', 'active');

INSERT OR IGNORE INTO sys_department(id, org_id, code, name) VALUES (1, 1, 'D001', '生产部');
INSERT OR IGNORE INTO pd_workshop(id, org_id, dept_id, code, name) VALUES (1, 1, 1, 'WS01', '一车间');
...
INSERT OR IGNORE INTO iam_admin_group(id, code, name, remark, sort_no) VALUES
...
INSERT OR IGNORE INTO iam_role(id, code, name, data_scope_type, is_system, remark) VALUES
...
INSERT OR IGNORE INTO iam_admin_group_role(group_id, role_id) VALUES
 (1,1),(2,2),(3,3),(3,4),(4,5),(4,6),(4,7),(4,10),(5,8),(5,9),(6,11),(6,12),(6,13);

INSERT OR IGNORE INTO iam_permission(code, name, domain, module, action) VALUES
...
INSERT OR IGNORE INTO iam_role_permission(role_id, permission_id)
...
INSERT OR IGNORE INTO iam_field_policy(role_id, field_key, field_name, visible, editable) VALUES
...
INSERT OR IGNORE INTO iam_menu_custom(role_id, domain, module, menu_key, visible, sort_no) VALUES
 (8, '生产管理', '扫码报工', '生产管理:扫码报工', 1, 10),
 (8, '生产管理', '联动式领料', '生产管理:联动式领料', 1, 20),
 (8, '工资管理', '工序工资', '工资管理:工序工资', 1, 30);

INSERT OR IGNORE INTO hr_employee(id, emp_no, name, org_id, dept_id, workshop_id, emp_type, status)
VALUES (1, 'E0001', '系统管理员', 1, 1, 1, 'office', 'active');

-- bcrypt(admin123) cost=10
INSERT OR IGNORE INTO iam_user(id, login_name, password_hash, employee_id, user_type, status)
...
INSERT OR IGNORE INTO prd_product_unit(product_id, unit_name, is_base, factor_to_base) VALUES
 (1, 'kg', 1, 1), (2, 'kg', 1, 1), (3, 'kg', 1, 1);

INSERT OR IGNORE INTO inv_balance(warehouse_id, product_id, batch_no, qty) VALUES
 (1, 1, 'B0801', 42000),
 (2, 2, 'B0803', 6500),
 (3, 3, 'B0802', 3200);

INSERT OR IGNORE INTO pay_process_wage_rate(process_id, rate, effective_from, status) VALUES
...
INSERT OR IGNORE INTO inv_box_code(id, code, product_id, warehouse_id, batch_no, qty, weight, current_process_id, current_step_id, status) VALUES
 (1, 'BX-RAW-DEMO', 1, 1, 'B0801', 1000, 1000, 8, 1, 'open');

INSERT OR IGNORE INTO pur_supplier(id, code, name, short_name, supplier_type, status, rating, is_preferred, uscc, settle_method, payment_days, lead_time_days, moq, default_warehouse_id, contact_json, remark) VALUES
...
INSERT OR IGNORE INTO pur_supplier_license(id, supplier_id, license_type, license_no, expire_date) VALUES
 (1, 1, '营业执照', '91450000MA5XXXXX01', '2027-12-31'),
 (2, 1, '食品经营许可', 'JY14500000001', '2026-09-30'),
 (3, 2, '营业执照', '91450000MA5XXXXX02', '2028-06-30');

INSERT OR IGNORE INTO pur_supplier_supply_item(id, supplier_id, product_id, is_preferred, moq, lead_time_days, last_price) VALUES
 (1, 1, 1, 1, 1000, 3, 1.85),
 (2, 2, 2, 1, 100, 7, 0.45),
 (3, 3, 1, 0, 500, 5, 1.90);

INSERT OR IGNORE INTO schema_meta(key, value) VALUES ('seeded', '1');
