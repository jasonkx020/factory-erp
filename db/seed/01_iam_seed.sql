...
('系统管理:自定义菜单:查看', '查看自定义菜单', '系统管理', '自定义菜单', '查看'),
('系统管理:自定义菜单:编辑', '编辑自定义菜单', '系统管理', '自定义菜单', '编辑'),
('系统管理:登录控制:查看', '查看登录控制', '系统管理', '登录控制', '查看'),
('系统管理:登录控制:编辑', '编辑登录控制', '系统管理', '登录控制', '编辑'),
('系统管理:账户冻结:查看', '查看账户冻结', '系统管理', '账户冻结', '查看'),
('系统管理:账户冻结:编辑', '账户冻结操作', '系统管理', '账户冻结', '编辑'),
('系统管理:基础设置:查看', '查看基础设置', '系统管理', '基础设置', '查看'),
('系统管理:基础设置:编辑', '编辑基础设置', '系统管理', '基础设置', '编辑'),
('系统管理:自定义打印:查看', '查看自定义打印', '系统管理', '自定义打印', '查看'),
('系统管理:自定义打印:编辑', '编辑自定义打印', '系统管理', '自定义打印', '编辑'),
('系统管理:操作日志:查看', '查看操作日志', '系统管理', '操作日志', '查看'),
('系统管理:数据修复:查看', '查看数据修复', '系统管理', '数据修复', '查看'),
('系统管理:数据修复:编辑', '执行数据修复', '系统管理', '数据修复', '编辑'),
('系统管理:业务闭环:查看', '查看业务闭环', '系统管理', '业务闭环', '查看'),
